...
void ToolOptionWidget::createUI()
{
    ...
    sizeSlider->setMinimumHeight(50);//改变最小高度
   // sizeSlider->setMinimumWidth(100);
    ...
    featherSlider->setMinimumHeight(50);//改变最小高度
    ...
    pLayout->addWidget( featherSlider, 10, 0, 1, 2 );
    pLayout->addWidget( usePressureBox, 12, 0, 1, 2 );
    pLayout->addWidget( preserveAlphaBox, 13, 0, 1, 2 );
    pLayout->addWidget( makeInvisibleBox, 15, 0, 1, 2 );
...
//    pLayout->addWidget( makeInvisibleBox, 14, 0, 1, 2 );
    ...
    optionGroup->setMaximumHeight(200);
